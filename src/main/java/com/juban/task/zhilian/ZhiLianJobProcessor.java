...
//
//    private Logger logger = LoggerFactory.getLogger(ZhiLianJobProcessor.class);
//
//    @Autowired
...
//    private String url = "https://sou.zhaopin.com/?jl=653&kw=java&kt=3";
//
...
//
//    @Override
//    public void getQianChengJob(Page page) {
//
//        try {
//            Thread.sleep(2000);
...
//
//        //List<Selectable> nodes = page.getHtml().css("div#listContent div.contentpile__content__wrapper").nodes();
//        List<Selectable> nodes = page.getHtml().css("div.contentpile__content__wrapper").nodes();
//        //List<Selectable> nodes = page.getHtml().css("a.contentpile__content__wrapper__item__info").nodes();
...
//        Spider.create(new ZhiLianJobProcessor())
