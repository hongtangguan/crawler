...
@Component
public class SaveBossJonInfoPipeline implements Pipeline {

    private Logger logger = LoggerFactory.getLogger(SaveBossJonInfoPipeline.class);
    @Autowired
...
*/
        ...
        if (jobInfo != null) {
            ...
            logger.info("入库完成..............."+ JSON.toJSONString(jobInfo));
        }
